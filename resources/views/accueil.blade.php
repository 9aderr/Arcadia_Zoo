@include('navbar')
    ...
    <section class="home" id="home">
        <div class="content">
            <h3>Profitez D’un Merveilleux Moment Proche De La Nature</h3>
            <a href="#" class="btn">Visitez le zoo</a>
    ...
    <section class="banner">
       <div class="imgbanner"></div>
        <div class="row">
            ...
            <div class="content">
                <h3>L'excellence des soins animaliers à Arcadia</h3>
            <p>Arcadia se démarque par ses soins vétérinaires minutieux et son alimentation sur mesure pour les animaux. Chaque jour, des vétérinaires examinent tous les animaux avant l'ouverture, tandis que les quantités de nourriture sont calculées selon les recommandations vétérinaires. Cette approche attentionnée, combinée à des habitats naturels recréés, assure des conditions optimales pour le bien-être de la faune.</p> 
            </div>
